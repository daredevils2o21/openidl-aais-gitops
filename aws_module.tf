...
module "aws_resources" {
    ...
    domain_name = "emergingtechdemo.com", #primary domain registered
    sub_domain_name = "trv", #subdomain name
    comments = "emtech node dns name resolutions"
    }
    #-------------------------------------------------------------------------------------------------------------------
    ...
    client_callback_urls         = ["https://openidl.dev.trv.emergingtechdemo.com/callback", "https://openidl.dev.trv.emergingtechdemo.com/redirect"]
    client_default_redirect_url  = "https://openidl.dev.trv.emergingtechdemo.com/redirect"
    client_logout_urls           = ["https://openidl.dev.trv.emergingtechdemo.com/signout"]
    cognito_domain               = "emergingtechdemo" #unique domain name
    ...
    #aws_input_bucket = "openidl-backend-resources-input-files-offline-umtotr"
